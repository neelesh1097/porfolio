...
function Home() {
  return (
    <section id="home">
    <div className="container mt-12 flex text-center justify-center">
...
<div className=' flex flex-col'>
        ...
        <div className="hero-action "><div className="hero-connect"><a className="anchor-link" href="#contact">Connect with me</a></div><div className="hero-resume">My resume</div></div>
     </div>
